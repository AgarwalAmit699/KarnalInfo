<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="RiceMill.aspx.cs" Inherits="RiceMill" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
        ...
        <div><h2 style="text-align: center">Rice <span style="color: #C75961">Mill</span><asp:Label ID="Category" runat="server" Text="Rice Mill" 
