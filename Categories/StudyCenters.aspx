<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="StudyCenters.aspx.cs" Inherits="StudyCenters" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
        ...
        <div><h2 style="text-align: center">Study <span style="color: #C75961">Centers</span><asp:Label ID="Category" runat="server" Text="Study Centers" 
