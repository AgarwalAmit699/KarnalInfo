<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="AluminiumWorks.aspx.cs" Inherits="AluminiumWorks" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    ...
	    <article>
        <h2 style="text-align: center">Aluminium <span style="color: #C75961">Works</span><asp:Label ID="Category" runat="server" Text="Aluminium Works" 
