<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="BookShopsStationary.aspx.cs" Inherits="BookShopsStationary" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
        ...
        <div><h2 style="text-align: center">Book <span style="color: #C75961">Shops/Stationary</span><asp:Label ID="Category" runat="server" Text="Book Shops/Stationary" 
