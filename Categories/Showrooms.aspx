<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="Showrooms.aspx.cs" Inherits="Showrooms" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
        ...
        <div><h2 style="text-align: center">Showrooms<asp:Label ID="Category" runat="server" Text="Showrooms" 
