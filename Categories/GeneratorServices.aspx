<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="GeneratorServices.aspx.cs" Inherits="GeneratorServices" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    <article>
        <div><h2 style="text-align: center">Generator <span style="color: #C75961">Services</span><asp:Label ID="Category" runat="server" Text="Generator Services" 
