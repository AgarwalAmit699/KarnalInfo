<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="CementConcreteMaterials.aspx.cs" Inherits="CementConcreteMaterials" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    <article>
        <div><h2 style="text-align: center">Cement/Concrete <span style="color: #C75961">Materials</span><asp:Label ID="Category" runat="server" Text="Cement/Concerete Materials" 
