<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="BanquetMarriagePalace.aspx.cs" Inherits="BanquetMarriagePalace" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    ...
	    <article>
        <h2 style="text-align: center">Banquet/Marriage <span style="color: #C75961">Palace</span><asp:Label ID="Category" runat="server" Text="Banquet/Marriage Palace" 
