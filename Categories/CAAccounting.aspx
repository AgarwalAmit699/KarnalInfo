<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="CAAccounting.aspx.cs" Inherits="CAAccounting" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    ...
	    <article>
        <h2 style="text-align: center">CA <span style="color: #C75961">Accounting</span>
            <asp:Label ID="Category" runat="server" Text="CA Accounting" 
