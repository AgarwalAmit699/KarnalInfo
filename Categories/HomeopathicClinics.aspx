<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="HomeopathicClinics.aspx.cs" Inherits="HomeopathicClinics" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    <article>
        <div><h2 style="text-align: center">Homeopathic <span style="color: #C75961">Clinics</span><asp:Label ID="Category" runat="server" Text="Homeopathic Clinics" 
         ...
         CausesValidation="False" onclick="Login_Click"/>
               ...
               <li>
                    ...
                    <li><asp:HyperLink ID="HyperLink1" runat="server" CssClass="selected" 
                            NavigateUrl="~/Signup.aspx">Add a Job</asp:HyperLink></li>
                    <br />
