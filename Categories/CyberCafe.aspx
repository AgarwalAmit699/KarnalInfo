<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="CyberCafe.aspx.cs" Inherits="CyberCafe" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    <article>
        <div><h2 style="text-align: center">Cyber <span style="color: #C75961">Cafe</span><asp:Label 
                ID="Category" runat="server" Text="Cyber Cafe" 
