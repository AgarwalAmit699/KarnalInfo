<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="AgricultureTools.aspx.cs" Inherits="AgricultureTools" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    ...
	    <article>
        <h2 style="text-align: center">Agriculture <span style="color: #C75961">Tools</span><asp:Label ID="Category" runat="server" Text="Agriculture Tools" 
