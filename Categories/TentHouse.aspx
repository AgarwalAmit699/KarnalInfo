<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="TentHouse.aspx.cs" Inherits="TentHouse" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
        ...
        <div><h2 style="text-align: center">Tent <span style="color: #C75961">House</span><asp:Label ID="Category" runat="server" Text="Tent House" 
