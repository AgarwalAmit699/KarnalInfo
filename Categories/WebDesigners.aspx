<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="WebDesigners.aspx.cs" Inherits="WebDesigners" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
        ...
        <div><h2 style="text-align: center">Web <span style="color: #C75961">Designers</span><asp:Label ID="Category" runat="server" Text="Web Designers" 
