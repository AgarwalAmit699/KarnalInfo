<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="ClothesMerchants.aspx.cs" Inherits="ClothesMerchants" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    <article>
        <div><h2 style="text-align: center">Clothes <span style="color: #C75961">Merchants</span><asp:Label ID="Category" runat="server" Text="Clothes Merchants" 
