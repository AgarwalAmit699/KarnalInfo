<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="SecuritySystem.aspx.cs" Inherits="SecuritySystem" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
        ...
        <div><h2 style="text-align: center">Security <span style="color: #C75961">System</span><asp:Label ID="Category" runat="server" Text="Security System" 
