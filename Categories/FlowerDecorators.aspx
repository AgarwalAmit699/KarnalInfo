<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="FlowerDecorators.aspx.cs" Inherits="FlowerDecorators" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    <article>
        <div><h2 style="text-align: center">Flower <span style="color: #C75961">Decorators</span><asp:Label ID="Category" runat="server" Text="Flower Decorators" 
