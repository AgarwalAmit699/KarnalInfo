<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="WeldingWorks.aspx.cs" Inherits="WeldingWorks" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
        ...
        <div><h2 style="text-align: center">Welding <span style="color: #C75961">Works</span><asp:Label ID="Category" runat="server" Text="Welding Works" 
