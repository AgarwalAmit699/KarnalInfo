<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="BloodBanks.aspx.cs" Inherits="BloodBanks" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
        ...
        <div><h2 style="text-align: center">Blood <span style="color: #C75961">Banks</span><asp:Label ID="Category" runat="server" Text="Blood Banks" 
