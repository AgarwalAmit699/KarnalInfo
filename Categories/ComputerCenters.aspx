<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="ComputerCenters.aspx.cs" Inherits="ComputerCenters" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
        ...
        <div><h2 style="text-align: center">Computer <span style="color: #C75961">Centers</span><asp:Label ID="Category" runat="server" Text="Computer Centers" 
