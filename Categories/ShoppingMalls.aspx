<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="ShoppingMalls.aspx.cs" Inherits="ShoppingMalls" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
        ...
        <div><h2 style="text-align: center">Shopping <span style="color: #C75961">Malls</span><asp:Label ID="Category" runat="server" Text="Shopping Malls" 
