<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="AutomobileSalePurchase.aspx.cs" Inherits="AutomobileSalePurchase" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    ...
	    <article>
        <h2 style="text-align: center">Automobile <span style="color: #C75961">Sale/Purchase</span><asp:Label ID="Category" runat="server" Text=" Automobile Sale/Purchase" 
