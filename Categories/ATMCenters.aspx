<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="ATMCenters.aspx.cs" Inherits="ATMCenters" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
        ...
        <div><h2 style="text-align: center">ATM <span style="color: #C75961">Centers</span><asp:Label ID="Category" runat="server" Text="ATM Centers" 
