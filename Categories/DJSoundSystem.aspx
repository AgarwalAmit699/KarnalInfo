<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="DJSoundSystem.aspx.cs" Inherits="DJSoundSystem" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    <article>
        <div><h2 style="text-align: center">D.J/Sound <span style="color: #C75961">System</span><asp:Label ID="Category" runat="server" Text="D.J/Sound System" 
