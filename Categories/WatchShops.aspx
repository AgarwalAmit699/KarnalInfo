<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="WatchShops.aspx.cs" Inherits="WatchShops" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
        ...
        <div><h2 style="text-align: center">Watch <span style="color: #C75961">Shops</span><asp:Label ID="Category" runat="server" Text="Watch Shops" 
