<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="AdvertisingAgencies.aspx.cs" Inherits="AdvertisingAgencies" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    ...
	    <article>
        <h2 style="text-align: center">Advertising <span style="color: #C75961">Agencies</span><asp:Label ID="Category" runat="server" Text="Advertising Agencies" 
