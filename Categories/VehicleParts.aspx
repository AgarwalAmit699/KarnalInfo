<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="VehicleParts.aspx.cs" Inherits="VehicleParts" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
        ...
        <div><h2 style="text-align: center">Vehicle <span style="color: #C75961">Parts</span><asp:Label ID="Category" runat="server" Text="Vehicle Parts" 
