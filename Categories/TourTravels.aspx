<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="TourTravels.aspx.cs" Inherits="TourTravels" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
        ...
        <div><h2 style="text-align: center">Tours <span style="color: #C75961">Travels</span><asp:Label ID="Category" runat="server" Text="Tours Travels" 
