<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="FancyDressMaterials.aspx.cs" Inherits="FancyDressMaterials" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    <article>
        <div><h2 style="text-align: center">Fancy Dress <span style="color: #C75961">Materials</span><asp:Label ID="Category" runat="server" Text="Fancy Dress Materials" 
