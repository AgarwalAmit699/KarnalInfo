<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="AyurvedicMedicine.aspx.cs" Inherits="AyurvedicMedicine" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    ...
	    <article>
        <h2 style="text-align: center">Ayurvedic <span style="color: #C75961">Medicine</span><asp:Label ID="Category" runat="server" Text="Ayurvedic Medicine" 
