<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="DrivingSchools.aspx.cs" Inherits="DrivingSchools" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    <article>
        <div><h2 style="text-align: center">Driving <span style="color: #C75961">Schools</span><asp:Label ID="Category" runat="server" Text="Driving Schools" 
