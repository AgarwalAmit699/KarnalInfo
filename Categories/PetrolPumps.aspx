<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="PetrolPumps.aspx.cs" Inherits="PetrolPumps" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    <article>
        <div><h2 style="text-align: center">Petrol <span style="color: #C75961">Pumps</span><asp:Label ID="Category" runat="server" Text="Petrol Pumps" 
