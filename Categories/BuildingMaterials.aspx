<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="BuildingMaterials.aspx.cs" Inherits="BuildingMaterials" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
        ...
        <div><h2 style="text-align: center">Building <span style="color: #C75961">Materials</span><asp:Label ID="Category" runat="server" Text="Building Materials" 
