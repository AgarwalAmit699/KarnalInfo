<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="BatterySuppliers.aspx.cs" Inherits="BatterySuppliers" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    ...
	    <article>
        <h2 style="text-align: center">Battery <span style="color: #C75961">Suppliers</span><asp:Label ID="Category" runat="server" Text="Battery Suppliers" 
