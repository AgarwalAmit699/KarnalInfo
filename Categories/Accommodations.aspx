<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="Accommodations.aspx.cs" Inherits="Accommodations" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    ...
	    <article>
        <h2 style="text-align: center">Accommodations
        <asp:Label ID="Category" runat="server" Text="Accommodations" 
