<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="BagsBriefcases.aspx.cs" Inherits="BagsBriefcases" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
        ...
        <div><h2 style="text-align: center">Bags/Briefcases<asp:Label ID="Category" runat="server" Text="Bags/Briefcases" 
