<%@ Page Title="" Language="C#" MasterPageFile="~/Categories/Content.master" AutoEventWireup="true" CodeFile="BeautyParloursSaloons.aspx.cs" Inherits="BeautyParloursSaloons" %>
...
<div class="clear"></div>
 <div id="body" class="width">
	...
	<section id="content" class="two-column with-right-sidebar">
	    ...
	    <article>
        <h2 style="text-align: center">Beauty <span style="color: #C75961">Parlours/Saloons</span><asp:Label ID="Category" runat="server" Text=" Beauty Parlours/Saloons" 
